        ...
        <div className='lg:col-start-2'>
          ...
          {order._isPaid ? (
            <p className='mt-2 text-base text-muted-foreground'>
              Your order was processed and your assets are ready for download
              below. We have sent your order details to{' '}
            ...
            <p className='mt-2 text-base text-muted-foreground'>
              We appreciate your order, and we are currently processing it. We
              will send your confirmation very soon.
            </p>
          )}
          ...
          <div className='mt-16 text-sm font-medium'>
            ...
            <div className='space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-muted-foreground'>
              ...
              <div className='flex items-center justify-between border-t pt-6 border-gray-200 text-gray-900'>
